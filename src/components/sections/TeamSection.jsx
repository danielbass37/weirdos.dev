      ...
      <div className='slide-content'>
        ...
        <div className='team-members'>
          <div className='team-member'>
            ...
            <a href='https://www.linkedin.com/in/daniel-bass-8b2bb81ab/' className='linkedin-icon' aria-label="Daniel's LinkedIn" target='_blank' rel='noopener noreferrer'>
          ...
          <div className='team-member'>
            ...
            <a href='https://www.linkedin.com/in/shaked-holtzer-weiss-533558210/' className='linkedin-icon' aria-label="Shaked's LinkedIn" target='_blank' rel='noopener noreferrer'>
              <img src={linkedinIcon} alt='LinkedIn' />
            </a>
          </div>
          <div className='team-member'>
            ...
            <a href='https://www.linkedin.com/in/gemanor/' className='linkedin-icon' aria-label="Gabriel's LinkedIn" target='_blank' rel='noopener noreferrer'>
              <img src={linkedinIcon} alt='LinkedIn' />
            </a>
          </div>
        </div>
